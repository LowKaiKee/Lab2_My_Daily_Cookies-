...
function sendEmail($otp,$email){
    $from = "noreply@mydailycookies.com";
    $to = $email;
    $subject = "From My Daily Cookies. Verify your account";
    $message = "Use the following link to verify your account :"."\n http://doubleksc.com/my_daily_cookies/php/verify_account.php?email=".$email."&key=".$otp;
    $headers = "From:" . $from;
